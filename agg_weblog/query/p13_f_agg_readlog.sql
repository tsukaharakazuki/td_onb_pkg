SELECT
	...
	${(Object.prototype.toString.call(media[params].read_first_regular_other_process.first) === '[object Array]')?','+media[params].read_first_regular_other_process.first.join():''}
FROM
	${media[params].read_db}.${media[params].read_tbl}
WHERE
	TD_TIME_RANGE(
	    time ,
	    NULL ,
