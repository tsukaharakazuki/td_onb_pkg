SELECT
	...
	td_client_id ,
	td_global_id ,
	${media[params].td_ssc_id} AS td_ssc_id ,
	${media[params].user_id} AS user_id ,
	...
	${(Object.prototype.toString.call(media[params].pv_columns.columns) === '[object Array]')?','+media[params].pv_columns.columns.join():''}
	${(Object.prototype.toString.call(media[params].pv_first_regular_other_process.first) === '[object Array]')?','+media[params].pv_first_regular_other_process.first.join():''}
FROM
